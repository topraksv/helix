...
export const tr = {
  ...
  cashflow: {
    ...
    viewTable: "Tablo",
    viewCards: "Kartlar",
    pinHint: "Kolonu sabitlemek için başlığına dokun.",
    monthTapHint: "Ay başlığına dokun, o ayın detayı açılsın.",
  ...
  importer: {
    ...
    reasonTooSmall: "Sayfa boş ya da çok küçük.",
    reasonNoMonths: "Ay satırı/sütunu bulunamadı (ör. Ocak 2025).",
    reasonNoColumns: "Ay başlıklarının üstünde kalem başlıkları bulunamadı.",
    // format guide
    guideTitle: "Nasıl bir tablo bekliyoruz?",
    layoutVertical: "Aylar ilk sütunda",
    layoutHorizontal: "Aylar üst satırda",
    guide1: "Bir eksende aylar (ör. Ocak 2025), diğerinde kalem başlıkları olsun.",
    guide2: "Her hücre, o ayın o kalemdeki tutarı olsun.",
    guide3: "Toplam yazdıysan (=500+300+700) kalemleri ayrı ayrı aktarırız; hücre yorumların not olur.",
    guide4: "Bakiye / eldeki para kolonları otomatik atlanır; açılış bakiyesi kurulur.",
    guide5: "Her sayfa ayrı bir yıl olabilir; her yıl kendi kolonlarını korur.",
    errorTitle: "Bu dosyayı okuyamadık",
    // preview + selection
    previewTitle: "Önizleme ve Seçim",
    sheetSelectTitle: "Aktarılacak sayfalar",
    unparsedNote: (names: string) => `Tablo bulunamayan sayfalar atlandı: ${names}.`,
    sheetChip: (name: string, months: number, cols: number) => `${name} · ${cols} kalem · ${months} ay`,
    columnsTitle: "Aktarılacak kalemler",
    breakdownHint: "• işaretli hücreler ayrı kalemlere bölündü ya da not taşıyor.",
    ...
    reimportPrompt: (years: string) => `${years} zaten içe aktarılmış. Bu yılların önceki aktarımını değiştir mi, üstüne ekle mi?`,
    reimportReplace: "Değiştir",
    reimportAdd: "Üstüne Ekle",
    doneTitle: (n: number) => `${n} kayıt aktarıldı`,
    doneHint: "Formüller ayrı kalemlere bölündü, yorumlar not oldu; Mali Tablo'da hücrelere dokunarak detaylandırabilirsin.",
