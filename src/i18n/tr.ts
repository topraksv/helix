...
export const tr = {
  ...
  onboarding: {
    ...
    importedOpeningNote: "Açılış bakiyen Excel'deki en erken aydan alındı; buradaki tutar yok sayılır.",
  ...
  settings: {
    ...
    openingDesc: "Başlangıç bakiyeni hiç girmediysen ya da yanlış girdiysen buradan düzelt. Günlük bakiye zaten işlemlerinle otomatik güncellenir.",
    openingScreenHint: "Burası yalnızca bir düzeltme aracıdır: başlangıç bakiyen hiç girilmemiş ya da hatalı girilmişse kullan. Şu an hesabındaki gerçek toplam parayı yaz; sistem bunu başlangıç ayına geri hesaplar ve tablodaki tüm değerleri buna göre yeniden kurar. Normal işlemlerini buradan değil, işlem ekleyerek gir.",
