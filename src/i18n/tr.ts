...
export const tr = {
  ...
  subs: {
    ...
    variableAmount: "Tutar her ay değişebilir",
    variableAmountHint: "Elektrik ve doğalgaz gibi ödemelerde yaklaşık tutarı burada tut; fatura geldiğinde gerçek tutarı ödeme satırında gir.",
    variableAmountBadge: "Tahmini",
