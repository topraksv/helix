...
export const tr = {
  ...
  auth: {
    ...
    signOutDialogDetail: "Hesap silinmez; eşitlenmemiş kayıtlar varsa çıkıştan önce açıkça gösterilir.",
    ...
    localSignOutDialogDetail: "Bu cihazdaki veriler geri alınamaz; çıkmadan önce yedek al.",
    ...
    restoringData: "Mali tablon ve ayarların bu cihaza hazırlanıyor",
    restoringDataFresh: "İlk çalışma alanın kuruluyor",
