...
export const tr = {
  ...
  sync: {
    ...
    shellError: "Ayarlar, senkronizasyon hatası var",
    shellPending: "Ayarlar, uzun süredir eşitlenmeyi bekleyen kayıt var",
  },
  catchup: {
  ...
  cashflow: {
    ...
    income: "Gelir", expense: "Gider", transfer: "Yatırım / Transfer", adjustment: "Bakiye Düzeltmesi",
  ...
  settings: {
    ...
    syncSection: "Senkronizasyon ve Sağlık",
    ...
    advancedOpeningTitle: "Gelişmiş · Başlangıç Bakiyesi",
    advancedOpeningHint: "Başlangıç ayını ve o aydaki açılış bakiyesini değiştirir. Bu, TÜM tabloyu baştan hesaplar — genelde gerekmez; onun yerine yukarıdan güncel bakiyeni düzelt.",
    advancedOpeningShow: "Gelişmiş ayarları göster",
  ...
  markets: {
    ...
    source: "Kaynak: Harem Altın kamusal akışı · resmî SLA yok",
    live: "Canlı",
    ...
    fallback: "Döviz hesaplarında varsa tarihli TCMB önbelleği kullanılmaya devam eder.",
  },
  dataState: {
  ...
  diagnostics: {
    title: "Tanılama ve Senkron Sağlığı",
    settingsDesc: "Kuyruk, karantina, sürüm ve son hata durumunu gör",
    privacy: "Bu özet yalnız teknik durumları içerir; tutar, not, e-posta, kimlik ve senkron payload'ı içermez.",
    export: "Özeti Dışa Aktar",
    loadFailed: "Tanılama özeti okunamadı. Tekrar deneyebilirsin.",
    release: "Çalışan Sürüm",
    version: "Uygulama",
    runtime: "Runtime",
    channel: "Kanal",
    update: "Güncelleme kimliği",
    embedded: "Yerleşik paket",
    sync: "Senkron Sağlığı",
    state: "Durum",
    lastSync: "Son başarılı senkron",
    pending: "Bekleyen kayıt",
    oldest: "En eski bekleyen",
    quarantined: "Karantinadaki kayıt",
    quarantineDetail: "Karantina Dağılımı",
    database: "Yerel Veritabanı",
    migration: "Son migration",
    recentEvents: "Son teknik olay",
    syncState: (state: string) => ({
      idle: "Güncel",
      syncing: "Senkronize ediliyor",
      error: "Senkron hatası",
      unconfigured: "Yalnız cihazda",
    }[state] ?? "Bilinmiyor"),
    ...
    severity: (severity: string) => severity === "error" ? "Hata" : "Uyarı",
    quarantineReason: (reason: string) => ({
      malformed_payload: "Bozuk veri",
      wrong_user: "Hesap uyuşmazlığı",
      invalid_row: "Geçersiz kayıt",
    }[reason] ?? "Bilinmeyen"),
    yes: "Evet",
    no: "Hayır",
    minutes: (count: number) => `${count} dk`,
    hours: (count: number) => `${count} sa`,
  },
  sources: {
