...
export const tr = {
  ...
  account: {
    ...
    freezeDesc: "Verilerin korunur; uygulama kilitlenir. Açmak için kimliğini doğrulaman gerekir.",
    freezeConfirmTitle: "Hesabı dondur",
    freezeConfirmBody:
      "Uygulama kilitlenecek ve açmak için kimlik doğrulaması (biyometri, şifre veya yeniden giriş) gerekecek. Verilerin silinmez. Devam edilsin mi?",
    freezeConfirm: "Dondur",
    frozenTitle: "Hesabın donduruldu",
    frozenBody: "Devam etmek için kimliğini doğrula.",
    reactivate: "Kilidi Aç ve Devam Et",
    reactivatePassword: "Şifreni gir",
    reactivateWrongPassword: "Şifre hatalı. Tekrar dene.",
    reactivateOffline: "İnternete bağlanılamadı. Şifreyle açmak için bağlantı gerekir; telefonda biyometri internetsiz de çalışır.",
    delete: "Hesabı Sil",
  ...
  settings: {
    ...
    computed: "Otomatik Kolonlar",
    computedDesc: "Seçtiğin kalemleri toplayan ya da farkını alan kolonları kendin oluştur.",
    persons: "Kişiler",
    ...
    opening: "Başlangıç ve Güncel Bakiye",
    openingDesc: "Takibe hangi aydan başladığını ve şu an hesabındaki güncel tutarı belirle.",
    openingScreenHint: "Şu an hesabındaki güncel toplam para. Kurulumda yanlış girildiyse buradan düzeltebilirsin; tablodaki değerler buna göre yeniden hesaplanır.",
