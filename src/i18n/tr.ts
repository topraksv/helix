...
export const tr = {
  ...
  tabs: { dashboard: "Durum", cashflow: productTerms.financialTable, subscriptions: "Abonelikler", calculator: "Araçlar", settings: "Ayarlar" },
  tabBar: { dashboard: "Durum", cashflow: productTerms.financialTable, subscriptions: "Abonelikler", calculator: "Araçlar", settings: "Ayarlar" },
  common: {
  ...
  account: {
    ...
    reactivatingBody: "Dondurma işareti kaldırılıyor ve cihazlarınla paylaşılmak üzere kaydediliyor",
  ...
  tx: {
    ...
    amountOptions: (currency: string) => `İade ve döviz seçenekleri · ${currency}`,
  ...
  subs: {
    title: "Abonelikler",
    activeCount: (count: number) => `${count} aktif düzenli ödeme`,
  ...
  persons: {
    ...
    watchedCount: (count: number) => `${count} izlenen`,
    addTitle: "Takibe kişi ekle",
    ownerHint: "Bu hesabın sahibi · bakiyeye dahil",
    watchedHint: "Yalnızca takip · bakiyeye dahil değil",
    overviewA11y: (total: number, watched: number) => `${total} kişi var. ${watched} kişi yalnızca takip ediliyor.`,
  },
  references: {
  ...
  operation: {
    ...
    requestingReset: "Bağlantı isteniyor",
    signingOutTitle: "Çıkış yapılıyor",
    signingOut: "Değişikliklerin gönderiliyor, sonra bu cihazdaki kopya siliniyor",
    deletingAccountTitle: "Hesap siliniyor",
    deletingAccount: "Buluttaki kimlik ve finans verileri siliniyor; ardından bu cihaz temizlenecek",
    freezePhase: {
      marking: "Dondurma işareti kaydediliyor",
      syncing: "Gönderilmemiş kayıtlar buluta aktarılıyor",
      "signing-out": "Bu cihazdaki oturum kapatılıyor",
      "rolling-back": "Dondurma geri alınıyor; verilerin korunuyor",
  ...
  sources: {
    walletTitle: "Cüzdanını oluştur",
    walletHint: "Kart, nakit ve hesaplarını işlemlerde seçebilmek için burada tanımla.",
    newSource: "Yeni ödeme yöntemi",
