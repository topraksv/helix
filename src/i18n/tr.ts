...
export const tr = {
  ...
  settings: {
    ...
    remoteLogos: "Abonelik Logolarını İnternetten Getir",
    remoteLogosHint: "Varsayılan olarak logolar cihazında üretilir. Açarsan yalnız abonelik listesi görünürken logo alan adı Google favicon servisine gönderilir; tercih sadece bu cihazda saklanır.",
