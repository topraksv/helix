...
export const tr = {
  ...
  investments: {
    ...
    editSetupTitle: "Yatırım başlangıcını düzelt",
    editSetupAction: "Başlangıcı Güncelle",
    editSetupDetailsHint: "Yanlış girilen başlangıç tarihini veya serbest bakiyeyi düzelt.",
    editOpening: "Başlangıç Bakiyesini Düzelt",
    openingEditBlocked: "Bu başlangıç bakiyesi mevcut alış ve aktarımları karşılamıyor. Önce ilgili hareketleri düzelt veya sil.",
    cash: "Serbest bakiye",
    ...
    productDeleted: "Yatırım ürünü ve hareketleri silindi",
    deleteProductTitle: "Ürünü tamamen sil",
    deleteProductBody: (name: string) =>
      `${name} ve ürüne bağlı tüm yatırım hareketleri sistemden kaldırılacak. Mali Tablo'ya yapılmış ayrı aktarımlar silinmez.`,
    productDeleteBlocked: "Bu ürünü silince serbest yatırım bakiyesi eksiye düşüyor. Önce bu üründen doğan Mali Tablo aktarımını veya sonraki alışları sil.",
