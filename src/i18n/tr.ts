...
export const tr = {
  ...
  dashboard: {
    ...
    forecastBalanceNotice: "Bu yalnızca ay sonu tahminidir; güncel bakiye ödeme tarihi gelene kadar değişmez.",
  ...
  subs: {
    ...
    estimatedAmountFieldLabel: "Tahmini tutar (opsiyonel)",
    variableAmount: "Tutarı sabit değil",
    variableAmountHint: "Elektrik, doğalgaz gibi faturalarda tutar her ay değişir. Bir tahminin varsa yukarı yazabilirsin; bilmiyorsan boş bırak — fatura geldiğinde gerçek tutarı ödeme ekranından gireceksin.",
  ...
  settings: {
    ...
    deleteCategoryReplacementTitle: "Kayıtları yeni kaleme aktar",
    deleteCategoryReplacementHint: (name: string, count: number) =>
      `“${name}” kalemine bağlı ${count} kayıt bulundu. Silmeden önce bu kayıtların hangi uyumlu kalemde devam edeceğini seç. Aynı adlı kalem varsa otomatik seçildi.`,
    deleteCategoryReplacementLabel: "Yeni kalem",
    deleteCategoryReplacementPlaceholder: "Bir kalem seç",
    deleteCategoryUncategorized: "Kategorisiz bırak (yalnız işlemler)",
    deleteCategoryReplacementConfirm: (name: string, target: string) =>
      `“${name}” silinecek ve bağlı kayıtlar “${target}” kalemine aktarılacak. Devam edilsin mi?`,
    deleteCategoryReplacementMissing: "Bu kalemdeki kayıtlar için uyumlu bir hedef kalem yok. Önce aynı türde bir kalem oluştur.",
