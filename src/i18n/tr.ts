...
export const tr = {
  ...
  matrixColor: {
    ...
    // What the mark MEANS, in the words a person would use about their own
    // ledger. "Bilgi" and "İyi gidiyor" said nothing a month later.
    token: {
      neutral: "İşaretledim",
      info: "Açıklaması var",
      success: "Doğruladım",
      warning: "Kontrol etmeliyim",
      critical: "Hatalı görünüyor",
    },
