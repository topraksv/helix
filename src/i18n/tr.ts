...
export const tr = {
  ...
  subs: {
    ...
    scheduleOverview: "31 günlük ödeme rotası",
    nextOverview: (name: string, date: string) => `Sıradaki: ${name} · ${date}`,
    noDueSoon: "Önümüzdeki 31 günde planlı ödeme yok.",
    tryMonthlyLoad: "TRY aylık karşılığı",
    today: "Bugün",
    next31Days: "31 gün",
    activeCount: "Aktif",
    dueSoonCount: "Yaklaşan",
    autoPayCount: "Otomatik",
    scheduleOverviewA11y: (active: number, upcoming: number, automatic: number) =>
      `${active} abonelik; 31 günde ${upcoming} ödeme; ${automatic} otomatik.`,
  ...
  operation: {
    signingIn: "Kimliğin doğrulanıyor",
    creatingAccount: "Hesabın hazırlanıyor",
    requestingReset: "Şifre bağlantın hazırlanıyor",
    signingOutTitle: "Güvenli çıkış",
    signingOut: "Değişiklikler gönderiliyor; ardından bu cihaz temizlenecek",
    deletingAccountTitle: "Hesap siliniyor",
    deletingAccount: "Bulut ve cihazdaki finans verileri siliniyor",
    freezePhase: {
