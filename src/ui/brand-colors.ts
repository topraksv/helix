...
export const BRAND: Record<string, { color: string; mark?: string }> = {
  ...
  "turk telekom": { color: "#0056a3", mark: "TT" },
  ...
  "puhutv": { color: "#00b0ff", mark: "p" },
  "d-smart": { color: "#e2001a", mark: "D" },
  "dsmart": { color: "#e2001a", mark: "D" },
  "digiturk": { color: "#ff6a00", mark: "dt" },
  "tivibu": { color: "#8bc63e", mark: "tv" },
  "superonline": { color: "#ffc900", mark: "SO" },
  "turknet": { color: "#0aa3dc", mark: "TN" },
  "millenicom": { color: "#ec1c24", mark: "M" },
  "migros": { color: "#f47d20", mark: "M" },
  "a101": { color: "#004a99", mark: "101" },
  "carrefoursa": { color: "#004e9e", mark: "C" },
  "bim": { color: "#e30613", mark: "B" },
  "sok": { color: "#f9b000", mark: "S" },
  "bip": { color: "#ffc900", mark: "bip" },
  "papara": { color: "#1a1a2e", mark: "P" },
  "ininal": { color: "#e5006d", mark: "in" },
  "marti": { color: "#00d1b2", mark: "m" },
  "bisu": { color: "#00a3e0", mark: "b" },
  "spotify premium": { color: "#1db954", mark: "S" },
  "apple one": { color: "#000000", mark: "A1" },
  "apple arcade": { color: "#000000", mark: "A" },
  "coursera": { color: "#0056d2", mark: "C" },
  "udemy": { color: "#a435f0", mark: "U" },
  "skillshare": { color: "#00ff84", mark: "SS" },
  "grammarly": { color: "#15c39a", mark: "G" },
  "trello": { color: "#0079bf", mark: "T" },
  "atlassian": { color: "#0052cc", mark: "A" },
  "vercel": { color: "#000000", mark: "V" },
  "cloudflare": { color: "#f38020", mark: "CF" },
  "substack": { color: "#ff6719", mark: "S" },
  "headspace": { color: "#ff7a00", mark: "H" },
  "calm": { color: "#2f80ed", mark: "C" },
  "proton": { color: "#6d4aff", mark: "P" },
  "protonmail": { color: "#6d4aff", mark: "P" },
  "mega": { color: "#d9272e", mark: "M" },
  "lastpass": { color: "#d32d27", mark: "LP" },
  "norton": { color: "#ffe01b", mark: "N" },
  "kaspersky": { color: "#00a88e", mark: "K" },
  "malwarebytes": { color: "#0d3ecc", mark: "MB" },
  "wetransfer": { color: "#409fff", mark: "WT" },
  "kindle": { color: "#232f3e", mark: "K" },
  "shazam": { color: "#0088ff", mark: "S" },
  "pinterest": { color: "#e60023", mark: "P" },
  "meta": { color: "#0866ff", mark: "M" },
  "instagram": { color: "#e4405f", mark: "ig" },
  "whatsapp": { color: "#25d366", mark: "W" },
  "uber": { color: "#000000", mark: "U" },
  "bolt": { color: "#34d186", mark: "B" },
  "booking": { color: "#003580", mark: "B" },
};
