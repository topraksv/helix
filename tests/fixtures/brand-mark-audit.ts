 ...
 * `tests/domain/brand-domains.test.ts` and `scripts/audit-brand-marks.mjs` are its
 * only readers.
 *
...
import type { MarkProvider } from "../../src/domain/brand-marks";
...
export const BRAND_MARK_AUDIT: Record<string, BrandMark> = {
  ...
  "adabank.com": { px: 152, provider: "google", sha: "d16bb0afe5ac" },
  ...
  "anadolubank.com.tr": { px: 64, provider: "google", sha: "7822ed801d8d" },
  ...
  "bkmexpress.com.tr": { px: 192, provider: "google", sha: "a33e74907ab1" },
  ...
  "bonus.com.tr": { px: 180, provider: "google", sha: "46ba03f02a9d" },
  ...
  "canva.com": { px: 193, provider: "google", sha: "b29642e87852" },
  ...
  "deezer.com": { px: 240, provider: "google", sha: "b51cd8038683" },
  ...
  "ea.com": { px: 256, provider: "google", sha: "a65aeaf74b4b" },
  ...
  "expressvpn.com": { px: 256, provider: "google", sha: "a2ebb01ab42d" },
  ...
  "github.com": { px: 256, provider: "iconhorse", sha: "c1ae49836ead" },
  ...
  "icbc.com.cn": { px: 256, provider: "google", sha: "24df94ff24de" },
  ...
  "kuveytturk.com.tr": { px: 256, provider: "iconhorse", sha: "ad3e6ad33c9a" },
  ...
  "malwarebytes.com": { px: 192, provider: "google", sha: "0d2d1baec051" },
  ...
  "meta.com": { px: 180, provider: "google", sha: "84213b8053da" },
  "microsoft.com": { px: 128, provider: "google", sha: "b6ba5811173d" },
  "microsoft365.com": { px: 48, provider: "google", sha: "c1715ffcc327" },
  ...
  "office.com": { px: 48, provider: "google", sha: "c1715ffcc327" },
  ...
  "primevideo.com": { px: 196, provider: "iconhorse", sha: "ba9a3a1b29be" },
  ...
  "skillshare.com": { px: 256, provider: "google", sha: "c2746812171a" },
  ...
  "substack.com": { px: 180, provider: "google", sha: "0f617ee4eb92" },
  ...
  "tivibu.com.tr": { px: 96, provider: "iconhorse", sha: "bc2fbe78a306" },
  ...
  "turkishbank.com": { px: 256, provider: "iconhorse", sha: "db2ca2fa6bcc" },
  ...
  "vercel.com": { px: 256, provider: "iconhorse", sha: "316ccd35da2a" },
  "visa.com.tr": { px: 48, provider: "google", sha: "f9e3d3ad57ae" },
  "vodafone.com.tr": { px: 180, provider: "google", sha: "4fd015c2bc7a" },
  "wetransfer.com": { px: 180, provider: "google", sha: "09711d3cc957" },
  ...
  "x.com": { px: 256, provider: "google", sha: "c74178c975f1" },
