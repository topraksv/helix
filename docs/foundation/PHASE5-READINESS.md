...
per-file V8 gate and/or the scoped Stryker hardening evidence. A regular Vitest
case is useful behavior evidence, but it remains **OUTSIDE** that hardened net
when its source is absent from both configurations.
